...
Then to start the initalize the server type this into the terminal:

node database-init.js

Then to start the server type this into the terminal:

node server.js

To reach the website the server is hosting, type this into your web browser:
